<template>
  <div class="all-cities-page">
    ...
    <div class="cities-scroll-container">
      <div
        class="cities-page"
        v-for="page in pagedItems"
        :key="page[0]?.id || page[0]?.name"
      >
        <div
          class="city-tile"
...
const pageSize = props.items.length
const pagedItems = computed(() => {
  const pages = []
  for (let i = 0; i < props.items.length; i += pageSize) {
    pages.push(props.items.slice(i, i + pageSize))
  }
  return pages
})
